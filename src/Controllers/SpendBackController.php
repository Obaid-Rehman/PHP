...
class SpendBackController extends BaseController
{
     ...
     *
     * @param string $spndToken Auto-generated unique identifier representing an individual
     *        spendback transaction and quote, prefixed with <i>spnd-</i>.
    ...
    public function retrieveSpendback(
        ...
        $_queryBuilder = '/spend-back/{spnd-token}';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function acceptSpendbackQuote(string $spndToken, string $xMyPayQuickerVersion): void
    {
        //prepare query string for API call
        $_queryBuilder = '/spend-back/{spnd-token}';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function cancelSpendbackQuote(string $spndToken, string $xMyPayQuickerVersion): void
    {
        //prepare query string for API call
        $_queryBuilder = '/spend-back/{spnd-token}';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function refundSpendbackFull(string $spndToken, string $xMyPayQuickerVersion): void
    {
        //prepare query string for API call
        $_queryBuilder = '/spend-back/{spnd-token}/refund';
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function refundSpendbackPartial(string $spndToken, string $xMyPayQuickerVersion): void
    {
        //prepare query string for API call
        $_queryBuilder = '/spend-back/{spnd-token}/refund';
    ...
    /**
     * Retrieve a list of all spendbacks that supports filtering, sorting, and pagination through existing
     * mechanisms.
     *
     * @param string $xMyPayQuickerVersion Date-based API Version specified in the header
     *        <i>required</i> on all calls.
     ...
     * `autoAcceptQuote` flag. If not automatically accepted, a POST is required to the spendback endpoint
     * using the token returned in the response. Quotes can be accepted, cancelled, or allowed to expire.
     * </i>
     *
     * @param string $xMyPayQuickerVersion Date-based API Version specified in the header
     *        <i>required</i> on all calls.
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function quoteSpendback(string $xMyPayQuickerVersion, ?array $body = null): void
    {
        //prepare query string for API call
        $_queryBuilder = '/spend-back';
